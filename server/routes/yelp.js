...
router.get('/businesses/search', yelpController.businessSearch, (req, res) => {
  // Upon success, res.locals.business will contain an array of businesses
  // returned by the Yelp Business Search API
  console.log('router.get /businesses/search', res.locals.business);
...
//    sate: state
//    country: country
router.get('/businesses/match', yelpController.businessMatch, (req, res) => {
  // Upon success, res.locals.business will contain a list of businesses
  // returned by the Yelp Business Match API
  console.log('router.get /businesses/match', res.locals.business);
